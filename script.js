...
(function () {
	var text_element = document.getElementById('joke_text'),
		...
		'What do you get when you cross a dyslexic, an insomniac, and an agnostic?<br>Someone who lays awake at night wondering if there is a dog.',
		...
		'I have an EpiPen.<br>My friend gave it to me when he was dying, it seemed very important to him that I have it.',
		...
		'I couldn’t believe that the highway department called my dad a thief.<br>But when I got home, all the signs were there.',
